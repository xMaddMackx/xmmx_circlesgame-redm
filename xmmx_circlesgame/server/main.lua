...
local resourceName = "^5[XMMX Development] ^4Circles Minigame ^0-" 

local function VersionCheck()
	PerformHttpRequest('https://raw.githubusercontent.com/xMaddMackx/xmmx_circlesgame/master/version', function(err, responseText, headers)
        Wait(3000)
        
		if not responseText then print("^1[XMMX-DEBUG] Version check for ^3(Circles Game) ^1failed! Github may be down.^0") return end
